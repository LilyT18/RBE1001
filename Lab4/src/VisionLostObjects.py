...
ai_vision_15__Green_Bean = Colordesc(1, 111, 191, 78, 14, 0.34)
# AI Vision Code Descriptions
ai_vision_15 = AiVision(Ports.PORT15, ai_vision_15__Green_Bean)
...
def checkForLostObject():
    ## this is not a "proper" event checker -- we need to be reasonable, so
    ## we don't check "we were below 20 before and at 20 now"
...
def cameraTimerCallback():
    ...
    objects = ai_vision_15.take_snapshot(ai_vision_15__Green_Bean)
    if objects: 
...
## Our main loop
while True:
    ## checks to see if the object is lost
